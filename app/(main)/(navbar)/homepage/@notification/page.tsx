...
import { NotificationPageBtn } from "./components/Button";
...
const LazyPararelNotif = dynamic(() => import("./components"), {
  loading: () => <p>Loading…</p>,
});

const NotificationPage = () => {
  return (
    <div className="relative overflow-y-auto group">
      <NotificationPageBtn />
      <LazyPararelNotif data={dummyNotifications} />
    </div>
  );
};
