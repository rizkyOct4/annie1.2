...
interface NotifDescriptionProps {
  data: HomepageNotification[];
}

const NotifDescription = ({ data }: NotifDescriptionProps) => {
    ...
    <div className="flex w-full gap-4">
      ...
      {state.isOpen && (
        <div className="bg-white rounded-xl shadow-lg max-w-xs max-h-[80vh] overflow-y-auto border">
          ...
          {/* bisa tambahkan detail notif di sini */}
...
export default NotifDescription;
